...
public class Sentiment {
	...
	public Sentiment() throws IOException {
		...
		// get some outputs getClassification(7,8);
	...
	private void getClassification(double negativityMeasure, double positivityMeasure) {
		...
		System.out.println("Using height defuzzification, the FLS recommends a tweet classification as "
				+ "classification of: " + rulebase.evaluate(0).get(classification));
		System.out.println("Using centroid defuzzification, the FLS recommends a tweet classification as "
				+ "classification of: " + rulebase.evaluate(1).get(classification));
	}
